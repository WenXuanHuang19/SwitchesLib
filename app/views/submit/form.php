 ...
 * Submission form.
 *
 * @var array  $designers  All available designers for the select.
...
$err = function (string $name) use ($errors) {
    if (!empty($errors[$name])) {
        echo '<span class="field-error" role="alert">' . e($errors[$name]) . '</span>';
    }
};
...
<div class="submit-page">
    ...
    <form class="submit-form" method="post" action="<?= url('/submit') ?>" enctype="multipart/form-data">
        ...
        <fieldset>
            <legend>Materials &amp; Structure</legend>
            <?php
        ...
        <fieldset>
            <legend>Tags &amp; Recommended Use</legend>
            <?php
